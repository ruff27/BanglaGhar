...
exports.createProperty = async (req, res) => {
  ...
  try {
    ...
    let propertyData = {
      ...req.body,
      createdBy: req.userProfile._id, // [cite: 4]
      listingStatus: req.body.listingStatus || "available", // [cite: 4]
      images: req.body.images || [], // Expecting S3 URLs generated by uploadPropertyImageToS3
    };
