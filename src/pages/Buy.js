...
// Updated property data for buying with prices in lakh taka (BDT)
const properties = [
  {
    id: 1,
...
const Buy = () => {
  ...
  // States for bedroom and bathroom filters
  ...
  // Function to format price in lakh/crore
    ...
    <Box sx={{ 
      ...
      <Container maxWidth="lg" sx={{ flexGrow: 1 }}>
        ...
        >
          ...
          >
            <Box sx={{ width: { xs: '100%', md: '70%' } }}>
              <Typography variant="subtitle1" fontWeight="medium" gutterBottom>
                Price Range: {priceRange[0] >= 100 ? `${(priceRange[0]/100).toFixed(1)} Crore` : `${priceRange[0]} Lakh`} - {priceRange[1] >= 100 ? `${(priceRange[1]/100).toFixed(1)} Crore` : `${priceRange[1]} Lakh`}
              </Typography>
              <Slider
                value={priceRange}
                ...
                valueLabelFormat={(value) => value >= 100 ? `${(value/100).toFixed(1)} Cr` : `${value} L`}
                sx={{
          ...
          {(searchTerm || propertyType !== 'all' || bedroomFilter !== 0 || bathroomFilter !== 0 || priceRange[0] !== 30 || priceRange[1] !== 200) && (
            <Box sx={{ mt: 3, display: 'flex', flexWrap: 'wrap', gap: 1, alignItems: 'center' }}>
              ...
              {(priceRange[0] !== 30 || priceRange[1] !== 200) && (
                <Chip 
                  label={`${priceRange[0] >= 100 ? `${(priceRange[0]/100).toFixed(1)} Cr` : `${priceRange[0]} L`} - ${priceRange[1] >= 100 ? `${(priceRange[1]/100).toFixed(1)} Cr` : `${priceRange[1]} L`}`}
                  onDelete={() => setPriceRange([30, 200])}
                  size="small"
                  sx={{ 
                    borderRadius: 2,
                    bgcolor: alpha(theme.palette.primary.main, 0.1),
        ...
        <Box mb={2} display="flex" justifyContent="space-between" alignItems="center">
          <Typography variant="h5" sx={{ fontWeight: 'bold', color: theme.palette.text.primary }}>
            {sortedProperties.length} Properties For Sale
          </Typography>
        ...
        >
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body2" gutterBottom>
              {priceRange[0] >= 100 ? `${(priceRange[0]/100).toFixed(1)} Crore` : `${priceRange[0]} Lakh`} - {priceRange[1] >= 100 ? `${(priceRange[1]/100).toFixed(1)} Crore` : `${priceRange[1]} Lakh`}
            </Typography>
            <Slider
              value={priceRange}
              onChange={handlePriceChange}
              ...
              <Box sx={{ mb: 4 }}>
                ...
                <Grid container spacing={4}>
                  <Grid item xs={12} md={8}>
                    ...
                    <Typography paragraph>
                      Perfect for {selectedProperty.bedrooms > 1 ? 'families or homeowners' : 'individuals or couples'} looking to invest in real estate, 
                  ...
                  <Grid item xs={12} md={4}>
                    <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: '1px solid', borderColor: alpha(theme.palette.primary.main, 0.1) }}>
                      ...
                      <TextField
                        ...
                        rows={4}
                        margin="normal"
                        defaultValue={`I'm interested in purchasing this ${selectedProperty.bedrooms} bedroom ${selectedProperty.type} in ${selectedProperty.location} priced at ৳${formatPrice(selectedProperty.price)}.`}
                        sx={{ mb: 3 }}
                      />
