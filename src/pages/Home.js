...
const StyledButton = styled(Button)(({ theme, variant }) => ({
  ...
  fontWeight: 600,
  textTransform: 'none',
  boxShadow: variant === 'contained' ? '0 4px 14px rgba(43, 123, 140, 0.25)' : 'none',
...
const Home = () => {
  ...
  useEffect(() => {
    if (isLoggedIn && user) {
      axios.get(`http://localhost:5001/api/users/${user}/wishlist`).then((response) => {
  ...
  const toggleWishlist = async (propertyId) => {
    ...
    try {
      if (isInWishlist) {
        ...
        // Add to wishlist
        await axios.post(`http://localhost:5001/api/users/${user}/wishlist`, { propertyId });
  ...
  const handleSearchInputChange = (e) => {
    ...
    if (query.length > 0) {
      ...
      const filtered = allProperties.filter(property => {
        ...
        const matchesLocation = property.location.toLowerCase().includes(query.toLowerCase());
        const matchesType = property.type.toLowerCase().includes(query.toLowerCase());
        ...
        const matchesBedrooms = numberInQuery ? 
          property.beds === parseInt(numberInQuery) : false;
        ...
        return matchesTitle || matchesLocation || matchesType || 
               matchesBedrooms || isAddressPattern;
      });
        ...
        <Container maxWidth="xl">
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6} sx={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                Find Your Perfect <Box component="span" sx={{ color: '#2B7B8C' }}>Home</Box> in Bangladesh
              </Typography>
              ...
              >
                BanglaGhor helps you discover your dream property with ease. Whether you're buying, selling, or renting, we've got you covered.
              </Typography>
          ...
          >
            <Box sx={{ position: 'relative', flex: 3, zIndex: 1001, width: '100%' }}>
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <SearchIcon sx={{ color: '#2B7B8C', fontSize: '1.3rem' }} />
                    </InputAdornment>
                  ),
                  sx: { 
                    borderRadius: '8px',
                    ...
                    '&:hover fieldset': { borderColor: 'rgba(43, 123, 140, 0.2)' },
                  ...
                  {filteredProperties.length > 0 ? (
                    <>
                        ...
                        >
                          ...
                          <Box sx={{ flex: 1 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.5 }}>
                              <LocationOnIcon sx={{ color: '#2B7B8C', fontSize: '0.9rem', mr: 0.5 }} />
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 1 }}>
                              <Box sx={{ 
                                ...
                                <BedIcon sx={{ color: '#2B7B8C', fontSize: '0.9rem', mr: 0.5 }} />
                              ...
                              <Box sx={{ 
                                ...
                                <BathtubIcon sx={{ color: '#2B7B8C', fontSize: '0.9rem', mr: 0.5 }} />
                                <Typography variant="body2" sx={{ fontSize: '0.8rem' }}>
                              ...
                              <Box sx={{ 
                                ...
                                <SquareFootIcon sx={{ color: '#2B7B8C', fontSize: '0.9rem', mr: 0.5 }} />
                                <Typography variant="body2" sx={{ fontSize: '0.8rem' }}>
                                  {property.sqft} ft²
                                </Typography>
                              </Box>
                      ...
                      <Box sx={{ p: 2, textAlign: 'center' }}>
                        ...
                        >
                          View all properties <ArrowForwardIcon sx={{ fontSize: '0.9rem', ml: 0.5 }} />
                        </Button>
                      </Box>
                    </>
                  ) : (
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <LocationOnIcon sx={{ color: '#2B7B8C', fontSize: '1.3rem' }} />
                  </InputAdornment>
                ),
                sx: { 
                  borderRadius: '8px',
                ...
                <PropertyCard>
                  ...
                  <CardContent sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                      <LocationOnIcon sx={{ color: '#2B7B8C', fontSize: '1rem', mr: 0.5 }} />
                      <Typography variant="body2" sx={{ color: '#0B1F23', opacity: 0.7 }}>
                        {property.location}
                      </Typography>
                    </Box>
                    ...
                    <Box sx={{ 
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <BedIcon sx={{ color: '#2B7B8C', fontSize: '1.1rem', mr: 0.5 }} />
                        <Typography variant="body2">{property.beds} Beds</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <BathtubIcon sx={{ color: '#2B7B8C', fontSize: '1.1rem', mr: 0.5 }} />
                        <Typography variant="body2">{property.baths} Baths</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <SquareFootIcon sx={{ color: '#2B7B8C', fontSize: '1.1rem', mr: 0.5 }} />
                    ...
                    <Box sx={{ 
                      ...
                      <Typography variant="h6" sx={{ color: '#2B7B8C', fontWeight: 700 }}>
                        {property.price}
                      </Typography>
                      
                      <Chip 
                        icon={property.type === 'house' ? <HouseIcon /> : <ApartmentIcon />}
                        label={property.type === 'house' ? 'House' : 'Apartment'}
                        size="small"
                        sx={{ 
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={8}>
              ...
              >
                Whether you're looking to buy, sell, or rent, BanglaGhor is here to make your experience seamless.
              </Typography>
            </Grid>
