...
// Add IconButton and Badge to imports
...
const DesktopNav = ({
  ...
  navLinks, //
  activeLink, //
  handleNavigate, // // General navigation handler from Navbar
  onListPropertyClick, //
}) => {
      ...
      {navLinks.map(
        (
          ...
          link.id === "properties" ? ( //
            ...
            <Button //
              key={link.id} //
              onClick={() => handleNavigate(link.path)} // Use handleNavigate for consistency
              sx={{
                //
                color: "text.primary", //
                textTransform: "none", //
