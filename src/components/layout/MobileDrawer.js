...
import ChatIcon from "@mui/icons-material/Chat"; // Or MailOutlineIcon for Chat
  ...
  return (
    ...
    >
      ...
      <List sx={{ px: 1 }}>
            ...
            link.id !== "properties" && ( //
              <ListItem key={link.id} disablePadding>
                ...
                <DrawerItem //
                  ...
                  onClick={() => handleLinkClick(link.path)} // Use handleLinkClick for path
                >
        ...
        {/* ... (Properties Links remain the same) ... */}
        <ListItem disablePadding>
          {" "}
          {/* */}
          <DrawerItem //
