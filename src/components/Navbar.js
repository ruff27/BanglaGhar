...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { id: 'properties', label: 'Properties', path: '/properties', icon: <HomeWorkIcon />, hasDropdown: true },
    { id: 'about', label: 'About Us', path: '/about', icon: <InfoIcon /> },
    { id: 'contact', label: 'Contact', path: '/contact', icon: <ContactsIcon /> },
  ];
  ...
  return (
    <>
      <HideOnScroll>
        <NavbarContainer 
          sx={{ 
            boxShadow: scrolled ? '0 4px 20px rgba(43, 123, 140, 0.15)' : '0 4px 12px rgba(43, 123, 140, 0.05)',
            py: scrolled ? 0.5 : 1,
          }}
        >
                    ...
                    link.hasDropdown ? (
                      <Box key={link.id}>
                        <DropdownNavButton 
                          ...
                          aria-controls={propertiesMenuOpen ? 'properties-menu' : undefined}
                          aria-haspopup="true"
                          aria-expanded={propertiesMenuOpen ? 'true' : undefined}
                          onClick={handlePropertiesClick}
                          endIcon={<KeyboardArrowDownIcon />}
                          sx={{ 
                            backgroundColor: propertiesMenuOpen ? 'rgba(43, 123, 140, 0.08)' : 'transparent',
                          }}
                        >
                          {link.label}
                        </DropdownNavButton>
                        ...
                        >
                          ...
                          >
                            <ListItemIcon>
                              <HomeWorkIcon fontSize="small" sx={{ color: '#2B7B8C' }} />
                            </ListItemIcon>
                          ...
                          >
                            <ListItemIcon>
                              <ApartmentIcon fontSize="small" sx={{ color: '#2B7B8C' }} />
                            </ListItemIcon>
                          ...
                          >
                            <ListItemIcon>
                              <SellIcon fontSize="small" sx={{ color: '#2B7B8C' }} />
                            </ListItemIcon>
              ...
              <IconContainer>
                ...
                {!isMobile && isLoggedIn && (
                  <ProfileButton onClick={handleProfileClick}>
                    ...
                    <KeyboardArrowDownIcon sx={{ ml: 0.5, fontSize: '1.2rem', color: '#BFBBB8' }} />
                  </ProfileButton>
                )}
                ...
                >
                  ...
                  >
                    <ListItemIcon>
                      <AccountCircleIcon fontSize="small" sx={{ color: '#2B7B8C' }} />
                    </ListItemIcon>
                  ...
                  >
                    <ListItemIcon>
                      <FavoriteIcon fontSize="small" sx={{ color: '#2B7B8C' }} />
                    </ListItemIcon>
                  ...
                  >
                    ...
                    <ListItemText sx={{ color: '#d32f2f' }}>Logout</ListItemText>
                  </MenuItem>
                </Menu>
          ...
          >
            <DrawerHeader>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#2B7B8C' }}>
                BanglaGhor
              </Typography>
              <IconButton 
                onClick={handleDrawerToggle} 
            ...
            {isLoggedIn ? (
              <Box sx={{ px: 3, py: 2 }}>
                <DrawerItem 
                  button
                  onClick={() => {
                    setProfileAnchor(profileAnchor ? null : document.getElementById('mobile-user-item'));
                  }}
                  id="mobile-user-item"
                  sx={{ my: 0 }}
                >
                  ...
                  <KeyboardArrowDownIcon 
                    sx={{ 
                      color: '#BFBBB8',
                      transform: Boolean(profileAnchor) ? 'rotate(180deg)' : 'rotate(0)',
                      transition: 'transform 0.3s'
                    }} 
                  />
                </DrawerItem>
                
                <Collapse in={Boolean(profileAnchor)} timeout="auto" unmountOnExit>
                ...
                link.hasDropdown ? (
                  <React.Fragment key={link.id}>
                    <DrawerItem 
                      ...
                      onClick={() => {
                        if (link.hasDropdown) {
                          setPropertiesAnchorEl(propertiesAnchorEl ? null : document.getElementById('mobile-properties-item'));
                        } else {
                    ...
                    >
                      ...
                      <KeyboardArrowDownIcon 
                        sx={{ 
                          color: '#BFBBB8',
                          transform: Boolean(propertiesAnchorEl) ? 'rotate(180deg)' : 'rotate(0)',
                          transition: 'transform 0.3s'
                        }} 
                      />
                    </DrawerItem>
                    
                    <Collapse in={Boolean(propertiesAnchorEl)} timeout="auto" unmountOnExit>
